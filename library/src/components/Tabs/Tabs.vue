...
// s 所有tabDOM对象
const tabDOMs = useTemplateRef("tabRefs") as ShallowRef<
  HTMLDivElement[] | null
>;
...
// ? nav 相关
const navDOM = useTemplateRef("navRef") as ShallowRef<HTMLDivElement | null>;
// s nav的尺寸
...
let isNavDragging = ref<boolean>(false);
onMounted(() => {
  let start = { x: 0, y: 0 };
...
// ? 底边悬浮条 hover-bar 相关
const navWrapDOM = useTemplateRef(
  "navWrapRef",
