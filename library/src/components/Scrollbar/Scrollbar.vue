...
// s 视口容器
const viewportDOM = useTemplateRef("viewportDOM") as ShallowRef<HTMLDivElement>;
...
// s 滚动条轨道DOM (垂直)
const verticalTrackDOM = useTemplateRef(
  "verticalTrack",
) as ShallowRef<HTMLDivElement>;
// s 滚动条轨道尺寸信息 (垂直)
const verticalTrackInfo = useElementBounding(verticalTrackDOM);
// s 滚动条DOM (垂直)
const verticalThumbDOM = useTemplateRef(
  "verticalThumb",
) as ShallowRef<HTMLDivElement>;
...
// s 滚动条轨道DOM (水平)
const horizontalTrackDOM = useTemplateRef(
  "horizontalTrack",
) as ShallowRef<HTMLDivElement>;
// s 滚动条轨道尺寸信息 (水平)
const horizontalTrackInfo = useElementBounding(horizontalTrackDOM);
// s 滚动条DOM (水平)
const horizontalThumbDOM = useTemplateRef(
  "horizontalThumb",
) as ShallowRef<HTMLDivElement>;
